...
//  DopodCinema
//
//  Created by The Ngoc on 2023/06/24.
//
...
protocol YouTubePlayerDelegate: NSObjectProtocol {
...
class YouTubePlayerView: UIView, WKNavigationDelegate {
    ...
    open func loadVideoID(_ videoID: String) {
        ...
        playerVars["origin"]         = "https://www.youtube.com" as AnyObject?
